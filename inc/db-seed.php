...
INSERT IGNORE INTO ueb_specialites_diplome (code, libelle, faculte_id, diplome_id) VALUES
    ...
    -- ===== FS — GCE A/L =====
    ('GCE_AL_SCI',  'GCE AD/L — Sciences',                               (SELECT id FROM ueb_facultes WHERE code = 'FS'),    (SELECT id FROM ueb_diplomes_admission WHERE code = 'gce_ad')),
    -- ===== FALSH — Bac =====
    ...
    -- ===== FALSH — GCE A/L =====
    ('GCE_AL_ART',  'GCE AD/L — Arts & Humanities',                      (SELECT id FROM ueb_facultes WHERE code = 'FALSH'), (SELECT id FROM ueb_diplomes_admission WHERE code = 'gce_ad')),
    ('GCE_AL_SOC',  'GCE AD/L — Social Sciences',                        (SELECT id FROM ueb_facultes WHERE code = 'FALSH'), (SELECT id FROM ueb_diplomes_admission WHERE code = 'gce_ad')),
    -- ===== FSEG — Bac =====
    ...
    -- ===== FSEG — GCE A/L =====
    ('GCE_AL_COM',  'GCE AD/L — Commerce / Economics',                   (SELECT id FROM ueb_facultes WHERE code = 'FSEG'), (SELECT id FROM ueb_diplomes_admission WHERE code = 'gce_ad')),
    ('GCE_AL_GEN',  'GCE AD/L — General',                                (SELECT id FROM ueb_facultes WHERE code = 'FSEG'), (SELECT id FROM ueb_diplomes_admission WHERE code = 'gce_ad')),
    -- ===== FSJP — Bac =====
    ...
    -- ===== FSJP — GCE A/L =====
    ('GCE_AL_ALL',  'GCE AD/L — Toutes séries',                          (SELECT id FROM ueb_facultes WHERE code = 'FSJP'), (SELECT id FROM ueb_diplomes_admission WHERE code = 'gce_ad'));
SQL,
        'ueb_filieres' => <<<SQL
INSERT IGNORE INTO ueb_filieres (code, libelle, faculte_id, type_formation, cycle) VALUES
    ('TIC', 'TIC — Technologies de l''Information et de la Communication', (SELECT id FROM ueb_facultes WHERE code = 'FS'), 'classique', 'tous'),
    ('PHY', 'Physique Appliquée', (SELECT id FROM ueb_facultes WHERE code = 'FS'), 'classique', 'tous'),
    ('CHIM', 'Chimie Appliquée', (SELECT id FROM ueb_facultes WHERE code = 'FS'), 'classique', 'tous'),
    ('GEO', 'Géosciences et Environnement', (SELECT id FROM ueb_facultes WHERE code = 'FS'), 'classique', 'tous'),
    ('ROSE', 'ROSE — Recherche Opérationnelle et Économétrie', (SELECT id FROM ueb_facultes WHERE code = 'FS'), 'classique', 'tous'),
    ('BIO', 'Biotechnologie et Pharmacognosie', (SELECT id FROM ueb_facultes WHERE code = 'FS'), 'classique', 'tous'),
    ('LP_BIO_MED', 'LP Sciences Biomédicales et Médico-Sanitaires', (SELECT id FROM ueb_facultes WHERE code = 'FS'), 'pro', 'tous'),
    ('LP_BIO_AGR', 'LP Sciences Biologiques Appliquées à l''Agriculture', (SELECT id FROM ueb_facultes WHERE code = 'FS'), 'pro', 'tous'),
    ('LP_TBM', 'LP Technologie Bio-Médicale', (SELECT id FROM ueb_facultes WHERE code = 'FS'), 'pro', 'tous'),
    ('LMF', 'Lettres Modernes Françaises', (SELECT id FROM ueb_facultes WHERE code = 'FALSH'), 'classique', 'tous'),
    ('LEA', 'Langues Étrangères Appliquées', (SELECT id FROM ueb_facultes WHERE code = 'FALSH'), 'classique', 'tous'),
    ('HIST', 'Histoire', (SELECT id FROM ueb_facultes WHERE code = 'FALSH'), 'classique', 'tous'),
    ('GEO_FALSH', 'Géographie', (SELECT id FROM ueb_facultes WHERE code = 'FALSH'), 'classique', 'tous'),
    ('PHILO', 'Philosophie', (SELECT id FROM ueb_facultes WHERE code = 'FALSH'), 'classique', 'tous'),
    ('SOCIO', 'Sociologie', (SELECT id FROM ueb_facultes WHERE code = 'FALSH'), 'classique', 'tous'),
    -- ===== FSEG — L1/L2 en tronc commun =====
    ('TC_FSEG', 'Tronc commun', (SELECT id FROM ueb_facultes WHERE code = 'FSEG'), 'classique', 'tronc_commun'),
    -- ===== FSEG — parcours a partir de la Licence 3 =====
    ('ECO_MF_L3', 'Économie Monétaire et Financière', (SELECT id FROM ueb_facultes WHERE code = 'FSEG'), 'classique', 'licence_3'),
    ('ECO_INT_L3', 'Économie Internationale', (SELECT id FROM ueb_facultes WHERE code = 'FSEG'), 'classique', 'licence_3'),
    ('ING_ECO_STAT_L3', 'Ingénierie Économique et Statistique', (SELECT id FROM ueb_facultes WHERE code = 'FSEG'), 'classique', 'licence_3'),
    ('CCA_L3', 'Comptabilité, Contrôle et Audit', (SELECT id FROM ueb_facultes WHERE code = 'FSEG'), 'classique', 'licence_3'),
    ('BANQ_MF_L3', 'Banque et Microfinance', (SELECT id FROM ueb_facultes WHERE code = 'FSEG'), 'classique', 'licence_3'),
    ('MKT_SO_L3', 'Marketing Stratégie Organisation', (SELECT id FROM ueb_facultes WHERE code = 'FSEG'), 'classique', 'licence_3'),
    ('ENT_MI_L3', 'Entrepreneuriat et Management de l''Innovation', (SELECT id FROM ueb_facultes WHERE code = 'FSEG'), 'classique', 'licence_3'),
    -- ===== FSEG — cycle master =====
    ('ECO_MF_M', 'Économie Monétaire et Financière', (SELECT id FROM ueb_facultes WHERE code = 'FSEG'), 'classique', 'master'),
    ('ECO_INT_M', 'Économie Internationale', (SELECT id FROM ueb_facultes WHERE code = 'FSEG'), 'classique', 'master'),
    ('POL_PUB_DEC_M', 'Politiques Publiques et de Décentralisation', (SELECT id FROM ueb_facultes WHERE code = 'FSEG'), 'classique', 'master'),
    ('ING_ECO_STAT_M', 'Ingénierie Économique et Statistique', (SELECT id FROM ueb_facultes WHERE code = 'FSEG'), 'classique', 'master'),
    ('CCA_M', 'Comptabilité, Contrôle et Audit', (SELECT id FROM ueb_facultes WHERE code = 'FSEG'), 'classique', 'master'),
